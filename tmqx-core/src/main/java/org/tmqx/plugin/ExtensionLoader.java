...
import org.tmqx.common.extension.URLClassExtensionLoader;
...
public class ExtensionLoader<T> {
    ...
    private static final String                                      Tmqx_DIRECTORY            = "META-INF/services/";
    ...
    private Map<String, Class<?>> loadExtensionClasses() {
        ...
        //  /Users/zxcs/Desktop/tf/TMQX/tmqx-broker/target/plugin
        File externalLibDir = new File(dir);
        //  目录不存在切换目录
        if (!externalLibDir.exists()) {
            externalLibDir = new File(File.separator + this.getJarDirectoryPath() + File.separator + "tmqx"
                    + File.separator + "plugin");
        }

        if (!externalLibDir.exists()) {
            externalLibDir = new File(File.separator + this.getJarDirectoryPath() + File.separator + "tmqx-broker"
                    + File.separator + "plugin");
        }
        ...
        if (externalLibDir.exists()) {
            ...
            if (files != null) {
                for (File f : files) {
                    ...
                    loadFile(extensionClasses, Tmqx_DIRECTORY, localClassLoader);
