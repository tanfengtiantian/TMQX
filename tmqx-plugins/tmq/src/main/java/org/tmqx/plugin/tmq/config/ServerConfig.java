package org.tmqx.plugin.tmq.config;

import org.tmqx.plugin.tmq.bean.TmqMessage;

import java.util.Properties;
import static org.tmqx.plugin.tmq.utils.Utils.*;
/**
 * @author tf
...
public class ServerConfig {
    ...
    public int getLogFileSize() {
        return getIntInRange(props, "log.file.size", 1 * 1024 * 1024 * 1024, TmqMessage.MinHeaderSize, Integer.MAX_VALUE);
    }
